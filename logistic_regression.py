...
def evaluate(x_train, x_test, y_train, y_test, **kwargs):
    ...
    model = LogisticRegression(random_state=42, **kwargs).fit(x_train, y_train)
...
def main():
    ...
    # experiment 2: 1-gram with different regularization
    ...
    # experiment 3: 2-gram with different regularization
    m3, p3, r3, f3 = evaluate(x_train2, x_test2, y_train2, y_test2,
                              penalty='elasticnet',
                              C=0.9,
                              solver='saga',
                              l1_ratio=0.5)
    model3_result = print_result(m3, 2, p3, r3, f3)
